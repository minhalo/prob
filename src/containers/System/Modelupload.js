...
import { activate, all, getCheckChangeEmail, getGroup, kdp, logout,filepost } from '../../services/userService';
...
class Modalupload extends Component {
    ...
    handleinsert = async () => {
        ...
        {
        let ok = filepost(this.props.isId,  this.state.filebase64, this.state.name)

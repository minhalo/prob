...
import { activate, all, getCheckChangeEmail, getGroup, kdp, logout,filepost, filepoststudent } from '../../services/userService';
...
class Modelangre extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isOpen: false,
...
export default connect(mapStateToProps, mapDispatchToProps)(Modelangre);
